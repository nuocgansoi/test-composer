...
class DateConverter
{
     ...
     * @param float $tz
     * @return Carbon $lunarDate
     *
     * Chỉ convert ngày/tháng/năm, ko convert giờ
     */
    public function solar2Lunar(Carbon $solarDate, $tz = 7.0)
    {
        $lunar = array_map('intval', $this->convertSolar2Lunar($solarDate->day, $solarDate->month, $solarDate->year, $tz));
        $lunarDate = Carbon::create($lunar[2], $lunar[1], $lunar[0]);
        $lunarDate->setTime($solarDate->hour, $solarDate->minute);
    ...
    public function lunar2Solar($day, $month, $year, $isLeap, $timeZone)
    {
        return array_map('intval', $this->convertLunar2Solar($day, $month, $year, $isLeap, $timeZone));
    }
